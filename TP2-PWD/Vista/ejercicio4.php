        ...
        <form class="row g-3" action="action/actionEj4.php" method="POST" id="cineform">
            ...
            <div class="col-md-6">
                <label for="restricciones" class="form-label font-weight-bold text-secondary">Restricciones de edad</label><br>
                    <input type="radio" name="restricciones" value="atp"> <label class="form-label" for="atp">Todos los públicos</label>
                    <input type="radio" name="restricciones" value="mayores7"> <label class="form-label" for="mayores7">Mayores de 7 años</label>
                    <input type="radio" name="restricciones" value="mayores18"> <label class="form-label" for="mayores18">Mayores de 18 años</label>
            </div>
            <div class="col-12">
